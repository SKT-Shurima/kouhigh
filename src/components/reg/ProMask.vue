<template>
	<div class="wrap" v-show='bol'>
		<div class="box">
			...
			<p style="margin-top: 10px;"><a href="javascript:void(0);" @click='protocolBol=true;' >《KouHigh商城服务协议》</a></p>
			<p><a href="javascript:void(0);" @click='protocolBol=true;' >《法律及隐私政策》</a></p>
